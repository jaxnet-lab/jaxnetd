...
// interface.
func (msg *fakeMessage) BtcDecode(r io.Reader, pver uint32, enc encoder.MessageEncoding) error {
	return nil
}
...
func (msg *fakeMessage) BtcEncode(w io.Writer, pver uint32, enc encoder.MessageEncoding) error {
