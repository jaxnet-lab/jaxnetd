...
var signatureTests = []signatureTest{
	...
	// at all. When not parsing DER signatures, which is done by by jaxnetd
...
func testSignCompact(t *testing.T, tag string, curve *KoblitzCurve, isCompressed bool) {
...
func TestSignCompact(t *testing.T) {
	for i := 0; i < 256; i++ {
		...
		compressed := i%2 != 0
		testSignCompact(t, name, S256(), compressed)
	}
}
