...
func ShouldHaveSerializedBlockHeight(header chain.BlockHeader) bool {
...
func CalcBlockSubsidy(height int32, chainParams *chain.Params) int64 {
...
func checkBlockHeaderSanity(header chain.BlockHeader, powLimit *big.Int, timeSource MedianTimeSource, flags BehaviorFlags) error {
...
func (b *BlockChain) checkBlockContext(block *btcutil.Block, prevNode chain.IBlockNode, flags BehaviorFlags) error {
	...
	if !fastAdd {
		...
		csvState, err := b.deploymentState(prevNode, chain.DeploymentCSV)
		if err != nil {
			return err
		}
...
func CheckTransactionInputs(tx *btcutil.Tx, txHeight int32, utxoView *UtxoViewpoint, chainParams *chain.Params) (int64, error) {
...
func (b *BlockChain) checkConnectBlock(node chain.IBlockNode, block *btcutil.Block, view *UtxoViewpoint, stxos *[]SpentTxOut) error {
	...
	// the new rules.
	segwitState, err := b.deploymentState(node.Parent(), chain.DeploymentSegwit)
	if err != nil {
		return err
	}
