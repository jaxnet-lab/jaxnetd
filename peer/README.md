...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/core/shard.core.git/peer)
...
```bash
$ go get -u gitlab.com/jaxnet/core/shard.core.git/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/gitlab.com/jaxnet/core/shard.core.git/peer#example-package--NewOutboundPeer)  
