...
func (b *BlockChain) checkBlockHeaderContext(header wire.BlockHeader, prevNode blocknode.IBlockNode, flags BehaviorFlags) error {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) checkBlockContext(block *btcutil.Block, prevNode blocknode.IBlockNode, flags BehaviorFlags) error {
...
func (b *BlockChain) checkBIP0030(node blocknode.IBlockNode, block *btcutil.Block, view *UtxoViewpoint) error {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) checkConnectBlock(node blocknode.IBlockNode, block *btcutil.Block, view *UtxoViewpoint, stxos *[]SpentTxOut) error {
