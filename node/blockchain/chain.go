...
func (b *BlockChain) calcSequenceLock(node blocknode.IBlockNode, tx *btcutil.Tx, utxoView *UtxoViewpoint, mempool bool) (*SequenceLock, error) {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) disconnectBlock(node blocknode.IBlockNode, block *btcutil.Block, view *UtxoViewpoint) error {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBestChain(node blocknode.IBlockNode, block *btcutil.Block, flags BehaviorFlags) (bool, error) {
