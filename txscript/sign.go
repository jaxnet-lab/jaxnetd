...
func RawTxInSignature(tx *wire.MsgTx, idx int, subScript []byte,
	hashType SigHashType, key *btcec.PrivateKey,
) ([]byte, error) {
...
func mergeScripts(chainParams *chaincfg.Params, tx *wire.MsgTx, idx int,
	pkScript []byte, class ScriptClass, addresses []jaxutil.Address,
...
func mergeMultiSig(tx *wire.MsgTx, idx int, addresses []jaxutil.Address,
...
type KeyClosure func(jaxutil.Address) (*btcec.PrivateKey, bool, error)

// GetKey implements KeyDB by returning the result of calling the closure.
func (kc KeyClosure) GetKey(address jaxutil.Address) (*btcec.PrivateKey,
	bool, error,
) {
	return kc(address)
}
...
type ScriptDB interface {
	GetScript(jaxutil.Address) ([]byte, error)
}

// ScriptClosure implements ScriptDB with a closure.
type ScriptClosure func(jaxutil.Address) ([]byte, error)

// GetScript implements ScriptDB by returning the result of calling the closure.
func (sc ScriptClosure) GetScript(address jaxutil.Address) ([]byte, error) {
	return sc(address)
}
