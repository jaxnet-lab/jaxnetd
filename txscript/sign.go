...
func sign(chainParams *chaincore.Params, tx *wire.MsgTx, idx int,
...
func mergeScripts(chainParams *chaincore.Params, tx *wire.MsgTx, idx int,
...
// signature script.
func SignTxOutput(chainParams *chaincore.Params, tx *wire.MsgTx, idx int,
