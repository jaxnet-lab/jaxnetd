...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/core/shard.core.git/netsync)
...
```bash
$ go get -u gitlab.com/jaxnet/core/shard.core.git/netsync
```
