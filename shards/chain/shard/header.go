...
func NewBlockHeader(version chain.BVersion, prevHash, merkleRootHash chainhash.Hash,
	mmr chainhash.Hash, timestamp time.Time, bits uint32, nonce uint32) *header {
...
func (h *header) MergeMiningRoot() chainhash.Hash { return h.merkleMountainRange }
...
func (h *header) SetMergeMiningRoot(value chainhash.Hash) { h.merkleMountainRange = value }
