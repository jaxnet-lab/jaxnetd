...
func TestVersion(t *testing.T) {
	...
	msg := NewMsgVersion(BeaconHeaderConstructor{}, me, you, nonce, lastBlock, big.NewInt(1))
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/jaxnetdtest:0.0.1/"
...
var baseVersionBIP0037Encoded = []byte{
	...
	0xff, 0xc0, 0xa8, 0x00, 0x01, 0x20, 0x8d, 0x01,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0xff, 0xff, 0x7f, 0x00, 0x00, 0x01, 0x20,
	0x8d, 0xf3, 0xe0, 0x01, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x0f, 0x2f, 0x6a, 0x61, 0x78, 0x6e, 0x65,
	0x74, 0x64, 0x3a, 0x30, 0x2e, 0x30, 0x2e, 0x31,
	0x2f, 0xfa, 0x92, 0x03, 0x00, 0x01, 0x01, 0x00,
	0x00, 0x00, 0x01, 0x01,
	...
	// 0xfa, 0x92, 0x03, 0x00, // Last block
	// 0x01, // Relay tx
	// 0x03, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01,
}
