...
func TestAlertErrors(t *testing.T) {
	...
	err = err
	// TODO: fix me wrong error got: *errors.errorString, want: wire.MessageError
	// if _, ok := err.(*MessageError); !ok {
	// 	t.Errorf("Alert.Deserialize wrong error got: %T, want: %T", err, MessageError{})
	// }
