...
const MaxMessagePayload = 1024*1024*1024*2 - 1 // 2 GB
...
func ReadMessageN(r io.Reader, pver uint32, btcnet JaxNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet JaxNet) (Message, []byte, error) {
