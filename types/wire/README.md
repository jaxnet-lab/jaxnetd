...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/jaxnetd/types/wire)
=======
...
```bash
$ go get -u gitlab.com/jaxnet/jaxnetd/types/wire
```
