...
//
// NOTE: This is a jaxnetd extension ported from github.com/decred/dcrd/dcrjson
...
func init() {
	...
	MustRegisterCmd("chain", "authenticate", (*AuthenticateCmd)(nil), flags)
	MustRegisterCmd("chain", "loadtxfilter", (*LoadTxFilterCmd)(nil), flags)
	MustRegisterCmd("chain", "notifyblocks", (*NotifyBlocksCmd)(nil), flags)
	MustRegisterCmd("chain", "notifynewtransactions", (*NotifyNewTransactionsCmd)(nil), flags)
	MustRegisterCmd("chain", "notifyreceived", (*NotifyReceivedCmd)(nil), flags)
	MustRegisterCmd("chain", "notifyspent", (*NotifySpentCmd)(nil), flags)
	MustRegisterCmd("chain", "session", (*SessionCmd)(nil), flags)
	MustRegisterCmd("chain", "stopnotifyblocks", (*StopNotifyBlocksCmd)(nil), flags)
	MustRegisterCmd("chain", "stopnotifynewtransactions", (*StopNotifyNewTransactionsCmd)(nil), flags)
	MustRegisterCmd("chain", "stopnotifyspent", (*StopNotifySpentCmd)(nil), flags)
	MustRegisterCmd("chain", "stopnotifyreceived", (*StopNotifyReceivedCmd)(nil), flags)
	MustRegisterCmd("chain", "rescan", (*RescanCmd)(nil), flags)
	MustRegisterCmd("chain", "rescanblocks", (*RescanBlocksCmd)(nil), flags)
}
