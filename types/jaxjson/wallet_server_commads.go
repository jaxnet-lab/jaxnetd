...
func init() {
	...
	MustRegisterCmd("wallet", "backupwallet", (*BackupWalletCmd)(nil), flags)
	MustRegisterCmd("wallet", "createmultisig", (*CreateMultisigCmd)(nil), flags)
	MustRegisterCmd("wallet", "createwallet", (*CreateWalletCmd)(nil), flags)
	...
	// MustRegisterCmd("wallet", "estimatesmartfee", (*EstimateSmartFeeCmd)(nil), flags)
	// MustRegisterCmd("wallet", "estimatefee", (*EstimateFeeCmd)(nil), flags)
	...
	MustRegisterCmd("wallet", "getaddressinfo", (*GetAddressInfoCmd)(nil), flags)
	MustRegisterCmd("wallet", "getbalance", (*GetBalanceCmd)(nil), flags)
	MustRegisterCmd("wallet", "getbalances", (*GetBalancesCmd)(nil), flags)
	...
	MustRegisterCmd("wallet", "importmulti", (*ImportMultiCmd)(nil), flags)
	...
	MustRegisterCmd("wallet", "loadwallet", (*LoadWalletCmd)(nil), flags)
	...
	MustRegisterCmd("wallet", "signrawtransactionwithwallet", (*SignRawTransactionWithWalletCmd)(nil), flags)
	MustRegisterCmd("wallet", "unloadwallet", (*UnloadWalletCmd)(nil), flags)
	...
	MustRegisterCmd("wallet", "walletcreatefundedpsbt", (*WalletCreateFundedPsbtCmd)(nil), flags)
	MustRegisterCmd("wallet", "walletprocesspsbt", (*WalletProcessPsbtCmd)(nil), flags)
}
...
// WalletCreateFundedPsbtCmd command.
func NewPsbtOutput(address string, amount jaxutil.Amount) PsbtOutput {
