...
// valid JSON type.  JSON-RPC 2.0 (which jaxnetd follows for some parts) only
...
func NewRequest(id interface{}, method MethodName, shardID uint32, params []interface{}) (*Request, error) {
	if !IsValidIDType(id) {
