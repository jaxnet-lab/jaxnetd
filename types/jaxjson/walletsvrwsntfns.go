...
const (
	...
	BtcdConnectedNtfnMethod = "jaxnetdconnected"
...
// BtcdConnectedNtfn defines the jaxnetdconnected JSON-RPC notification.
...
func init() {
	...
	MustRegisterCmd("wallet", BtcdConnectedNtfnMethod, (*BtcdConnectedNtfn)(nil), flags)
