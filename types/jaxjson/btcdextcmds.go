...
// a chain server with jaxnetd extensions.
...
// standard Bitcoin command.  It is an extension for jaxnetd.
...
// It is an extension for jaxnetd.
...
// NewGetShardHeadersCmd returns a new instance which can be used to issue a
// getheaders JSON-RPC command.
//
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrd/dcrjson.
