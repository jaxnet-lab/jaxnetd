...
func GenerateKey(networkCfg *chaincore.Params) (*KeyData, error) {
...
func NewKeyData(privateKeyString string, networkCfg *chaincore.Params) (*KeyData, error) {
...
func MakeMultiSigScript(keys []string, nRequired int, net *chaincore.Params) (*MultiSigAddress, error) {
...
func DecodeScript(script []byte, net *chaincore.Params) (*btcjson.DecodeScriptResult, error) {
