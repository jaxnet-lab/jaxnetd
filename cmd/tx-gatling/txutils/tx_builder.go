...
type TxBuilder interface {
	...
	SetRefundableTimeLock(lockTime uint32) TxBuilder
...
func (t *txBuilder) SetRefundableTimeLock(lockTime uint32) TxBuilder {
	t.lockTime = lockTime
	t.txVersion = wire.TxVerRefundableTimeLock
	return t
}
