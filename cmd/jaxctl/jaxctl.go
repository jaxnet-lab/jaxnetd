...
func main() {
	...
	cmd, err := jaxjson.NewCmd(method, params...)
	if err != nil {
		// Show the error along with its error code when it's a
		// jaxjson.Error as it reallistcally will always be since the
		...
		// The error is not a jaxjson.Error and this really should not
	...
	marshalledJSON, err := jaxjson.MarshalCmd(1, shardID, cmd)
	if err != nil {
