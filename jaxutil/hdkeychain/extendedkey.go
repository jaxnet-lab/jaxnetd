...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := jaxutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*jaxutil.AddressPubKeyHash, error) {
	pkHash := jaxutil.Hash160(k.pubKeyBytes())
	return jaxutil.NewAddressPubKeyHash(pkHash, net)
}
