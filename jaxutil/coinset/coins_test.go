...
import (
	...
	"gitlab.com/jaxnet/jaxnetd/jaxutil/coinset"
...
func NewCoin(index int64, value jaxutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = jaxutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = jaxutil.NewTxFromBytes(testSimpleCoinTxBytes)
