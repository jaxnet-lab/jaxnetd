...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/jaxnetd/btcutil/coinset)
...
```bash
$ go get -u gitlab.com/jaxnet/jaxnetd/jaxutil/coinset
```
