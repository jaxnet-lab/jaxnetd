...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/jaxnetd/network/peer)
...
```bash
$ go get -u gitlab.com/jaxnet/jaxnetd/network/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/gitlab.com/jaxnet/jaxnetd/network/peer#example-package--NewOutboundPeer)  
