...
//
// This function MUST be called with the state locked.
func (state *gbtWorkState) updateBlockTemplate(s *CommonChainRPC, useCoinbaseValue bool) error {
	...
	if template == nil || state.prevHash == nil ||
		...
		s.Log.Debugf("Generated block template (timestamp %v, "+
		...
		s.Log.Debugf("Updated block template (timestamp %v, "+
