...
var rpcResultTypes = map[string][]interface{}{
	...
	"getBeaconBlockTemplate": {(*jaxjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getShardBlockTemplate":  {(*jaxjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getBlockTemplate":       {(*jaxjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
...
var helpDescsEnUS = map[string]string{
	...
	// GetBeaconBlockVerboseResult help.
