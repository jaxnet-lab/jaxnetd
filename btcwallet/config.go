...
import (
	...
	"gitlab.com/jaxnet/core/shard.core.git/btcwallet/internal/cfgutil"
	"gitlab.com/jaxnet/core/shard.core.git/btcwallet/internal/legacy/keystore"
	"gitlab.com/jaxnet/core/shard.core.git/btcwallet/lightclient"
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.UseSPV {
		...
		fmt.Println("cfg.DisableClientTLS ", cfg.DisableClientTLS)
