...
import (
	...
	"gitlab.com/jaxnet/core/shard.core.git/btcwallet/wallet"
...
var rpcHandlers = map[string]struct {
	...
	"estimatesmartfee":       {handler: handleEstimateSmartFee},
	"getblockstats":          {handler: handleGetBlockStats},
	"getchaintxstats":        {handler: handleGetChaintxStats},
...
func lazyApplyHandler(request *btcjson.Request, w *wallet.Wallet, chainClient chain.Interface) lazyHandler {
	...
	if ok && handlerData.handlerWithChain != nil && w != nil && chainClient != nil {
		return func() (interface{}, *btcjson.RPCError) {
			fmt.Println("request ", request.Jsonrpc, string(request.Params[0]))
...
func handleEstimateSmartFee(cmd interface{}, w *wallet.Wallet) (interface{}, error) {
	fmt.Println("handleEstimateSmartFee", cmd)
...
func handleGetBlockStats(cmd interface{}, w *wallet.Wallet) (interface{}, error) {
	//c := cmd.(*btcjson.GetBlockStatsCmd)
	res := btcjson.GetBlockStatsResult{}
	return res, nil
}

func handleGetChaintxStats(cmd interface{}, w *wallet.Wallet) (interface{}, error) {
