...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/core/shard.core/btcutil/coinset)
...
```bash
$ go get -u gitlab.com/jaxnet/core/shard.core/btcutil/coinset
```
