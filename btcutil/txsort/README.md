...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/gitlab.com/jaxnet/core/shard.core/btcutil/txsort)
...
```bash
$ go get -u gitlab.com/jaxnet/core/shard.core/btcutil/txsort
```
